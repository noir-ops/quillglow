  ...
  return (
    <section ref={ref} id="study-agent" className="relative overflow-hidden py-28 md:py-36" style={{ background: "linear-gradient(180deg, #FFFDF7 0%, #F3EEFF 40%, #FFFDF7 100%)" }}>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          Paste a topic. StudyPilot runs 8 steps and delivers revision notes, a mind map, a practice exam, YouTube videos, and a personalised review schedule — in under 60 seconds.
        </motion.p>
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-start">
          ...
          >
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                <p className="font-800 text-[#1C1917]">StudyPilot</p>
