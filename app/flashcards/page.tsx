  ...
  return (
    <AppLayout>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Single vertical stack, not a side-by-side grid — the AI
            generator (inside FlashcardContent, or its own prompt in the
            empty state) is meant to be the first thing on the page, and
            the deck list last. */}
