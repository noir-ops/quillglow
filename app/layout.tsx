...
export const metadata: Metadata = {
  ...
  title: {
    default: "QuillGlow - StudyPilot & Smart Study App for Students | Revision Notes, Mind Maps & More",
  ...
  description:
    "QuillGlow's StudyPilot builds your entire study system in seconds — personalised revision notes, mind map, practice exam, YouTube videos & review schedule. Trusted by 10,000+ students. Try free or get Genius for $4.99.",
  keywords: [
    "AI study agent",
  ...
  openGraph: {
    ...
    siteName: "QuillGlow",
    title: "QuillGlow — StudyPilot builds your full study system in seconds",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "QuillGlow StudyPilot — Complete personalised study system",
      },
    ],
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              offers: [
                {
                  ...
                  price: "0",
                  priceCurrency: "USD",
                  description: "Free forever plan with 1 StudyPilot run per day and 3 EchoMind sessions per month",
                },
                {
                  "@type": "Offer",
                  ...
                  price: "4.99",
                  priceCurrency: "USD",
                  description: "Unlimited StudyPilot runs, unlimited EchoMind sessions, and all premium features",
              ...
              featureList: [
                "StudyPilot — complete study system generator",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "Product",
              name: "QuillGlow StudyPilot",
              url: "https://www.quillglow.com/#study-agent",
              description:
                "StudyPilot builds a complete personalised study system in seconds — revision notes, mind map, practice exam, YouTube videos, and a smart review schedule — all tailored to your weak areas.",
