  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl relative">
        {/* Back button — the shop is reached from inside the app, so this
            should return to the dashboard, not the logged-out marketing
            homepage (that page has none of the learner's session-scoped
            navigation, so it reads as "signed out" even when it isn't). */}
        <Link href="/dashboard">
          <Button
            variant="outline"
            size="sm"
