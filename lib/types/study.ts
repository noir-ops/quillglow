export interface Task {
  ...
  // Set only on tasks mirrored from a study plan goal (061). Editing or
  // completing either side keeps both in sync — see
  // app/api/tasks/[id]/route.ts and app/api/study-plans/goals/toggle.
